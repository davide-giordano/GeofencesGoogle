...
public class MainActivity extends FragmentActivity {
    ...
    public void onRegisterClicked(View view) {
    	...
    	Log.d("onRegisterClicked","entering onRegisterMethod");
        /*
         ...
         * permitted range
         */
        Log.d("onRegisterClicked","before checking input fields");
        /*if (!checkInputFields()) {
            return;
        }*/
         ...
         */
        Log.d("onRegisterClicked","retrieving geofence data");
        ...
        Log.d("onRegisterClicked","adding first geofence");
